...
const Notes = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const response = await fetch("http://localhost:8000/api/ai/bot/", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          task: "chat",
          step: "interaction",
          guidelines: ["Provide helpful and accurate responses", "Maintain a friendly and encouraging tone"],
          why: ["To assist users with their learning journey", "To provide guidance and support"],
