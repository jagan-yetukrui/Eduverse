...
SECRET_KEY = "django-insecure-rp8ont2m%j9&*8f-^k#lwgdcb_a-hbsx#=_nvg&)3#ix4qmv^6"
...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(
        days=7
    ),  # Optionally, set refresh token to last 7 days
    "ROTATE_REFRESH_TOKENS": False,  # Optional: Refresh token rotation behavior
